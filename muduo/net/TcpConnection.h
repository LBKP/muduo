                      ...
                      public std::enable_shared_from_this<TcpConnection>
{
 public:
  ...
  virtual bool connected() const { return state_ == kConnected; }
  virtual bool disconnected() const { return state_ == kDisconnected; }
  ...
  virtual void send(Buffer *message); // this one will swap data
  virtual void shutdown();            // NOT thread safe, no simultaneous calling
  // void shutdownAndForceCloseAfter(double seconds); // NOT thread safe, no simultaneous calling
  virtual void forceClose();
  virtual void forceCloseWithDelay(double seconds);
