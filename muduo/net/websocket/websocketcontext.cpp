...
namespace wss
{
	...
	bool WebSocketContext::processConnectionLine(const char * begin, const char * end)
	{
		return true;
	}
	...
	bool WebSocketContext::processWebSocketKeyLine(const char * begin, const char * end)
	{
		bool succeed = false;
		const char* start = begin;
		const char* space = std::find(start, end, ' ');
	...
	bool WebSocketContext::processWebSocketVeisionLine(const char * begin, const char * end)
	{
		return true;
	}
}
